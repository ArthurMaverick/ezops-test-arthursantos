...
const Home: NextPage = () => {
const [socket, setSocket] = useState<Socket>(io('https://service.arthursantos.tech:8443/', { transports: ['websocket', 'polling', 'flashsocket'] }))
...
async function request () {
  await req.post('https://service.arthursantos.tech:8443/messages', {name: name, message: message} ).catch(err=>err)
}
