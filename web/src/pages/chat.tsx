...
const Home: NextPage = () => {
const [socket, setSocket] = useState<Socket>(io('http://arthursantos.tech:2052/', { transports: ['websocket', 'polling', 'flashsocket'] }))
...
async function request () {
  await req.post('http://arthursantos.tech:2052/messages', {name: name, message: message} ).catch(err=>err)
}
