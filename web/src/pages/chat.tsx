...
const Home: NextPage = () => {
const [socket, setSocket] = useState<Socket>(io('https://arthursantos.tech:8433/', { transports: ['websocket', 'polling', 'flashsocket'] }))
...
async function request () {
  await req.post('https://arthursantos.tech:8433/messages', {name: name, message: message} ).catch(err=>err)
}
